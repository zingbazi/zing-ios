...
- (void)keyboardDidShow:(NSNotification*)notification;
{
    ...
    CGPoint center = [[notification.userInfo objectForKey:UIKeyboardAnimationCurveUserInfoKey] CGPointValue];
    CGRect  rect   = [[notification.userInfo objectForKey:UIKeyboardAnimationCurveUserInfoKey] CGRectValue];
...
- (void)positionInput:(CGRect*)kbRect x:(float)x y:(float)y
{
    ...
    if (multiline)
    {
        ...
        inputView.hidden = inputHidden ? YES : NO;
    }
    else
    {
