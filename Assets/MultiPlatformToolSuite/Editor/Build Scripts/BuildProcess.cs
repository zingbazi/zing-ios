...
public class BuildProcess : ScriptableObject
{
	...
	//=====
	static string[] standaloneScenes = new string[] { @"Assets/Scenes/MainGame.unity" };
	...
	//=====
	const string bundleIdentifier = "com.empiricaldevelopment.ifestrivia.dev";

	const string genericBuildName = "Zing";
	const string genericProductName = "Zing";
...
#if !UNITY_3_5
	[MenuItem("Window/MultiPlatform ToolKit/Build/Build WinPhone", false, 1)]
	public static void BuildNonDebugWinPhone ()
	{
		PlatformSpecificChanges (Platform.WinPhone);
...
#if !UNITY_3_5
	[MenuItem("Window/MultiPlatform ToolKit/Build/Debug/Build WinPhone", false, 1)]
	...
	public static void PlatformSpecificChanges (Platform platform, bool stripMaterials) {
		...
		if (platform == Platform.WebPlayer)
			...
			levels = naClScenes;	
#if !UNITY_3_5
		else if (platform == Platform.WinPhone)
	...
	public static void BuildWinPhone (bool debug, string buildName, string productName)
	{
		...
		//You may choose to pre-process your WinPhone build here.
		...
		if(doWinBuild)
		{
			...
			if (err != string.Empty) {
				...
				//You may choose to post-process your WinPhone build here.
			}
		}
		else 
		{
