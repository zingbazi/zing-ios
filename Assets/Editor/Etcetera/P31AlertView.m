...
- (void)setupInitialFrame
{
	...
	if( _title )
	{
		_titleSize = [_title sizeWithFont:[UIFont boldSystemFontOfSize:18] constrainedToSize:CGSizeMake( 270.0, 500.0 ) lineBreakMode:NSLineBreakByWordWrapping];
	...
	if( _message )
	{
		_messageSize = [_message sizeWithFont:[UIFont systemFontOfSize:14] constrainedToSize:CGSizeMake( 260.0, 500.0 ) lineBreakMode:NSLineBreakByWordWrapping];
