...
class TestFlightMessageWindow : TestFlightWindow
{
	...
	public void OnEnable()
	{
		...
		TestFlightNonProSchemaWindow.OnSchemasLoaded += OnSchemasLoaded;
	}
	...
	void OnSchemasLoaded(TestFlightXCodeSchemas schema)
	{
		allSchemas = schema;
	...
	public static void CreateWindow()
	{
		...
		window.position = new Rect(10, 10, 900, 450);
	...
	{		
		...
		TestFlightPreferencesWindow.DrawSubUserSettings(preferences, ref showUserLists, useThinStyle, allProvisions, ref allSchemas, allIdentities);
		GUILayout.EndVertical();
		GUILayout.EndHorizontal();
		GUILayout.EndArea();
	}
